...
import { getYardsSearch } from "../../services/yardAPI";
import { Skeleton } from "antd";
import { useParams } from "react-router-dom";
import CourtCard from "../ListCourt/CourtCard";
import RecommendedCard from "../ListCourt/Recommend";
...
const ListCourtSearch = () => {
  ...
  useEffect(() => {
    const fetchYards = async () => {
      ...
      const data = await getYardsSearch(query, currentPage - 1);
      if (data) {
        setCourts(data);
...
export default ListCourtSearch;
